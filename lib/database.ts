...
const statements = [
  ...
  `CREATE TABLE IF NOT EXISTS account_notifications (id TEXT PRIMARY KEY, account_type TEXT NOT NULL CHECK(account_type IN ('administrator','member')), account_id TEXT NOT NULL, type TEXT NOT NULL, title TEXT NOT NULL, body TEXT NOT NULL, match_id TEXT, read_at TEXT, created_at TEXT NOT NULL)`,
