...
export const instanceConfigurations = sqliteTable("instance_configuration", {
  ...
  publicLogoSize: integer("public_logo_size").notNull().default(44),
  adminLogoSize: integer("admin_logo_size").notNull().default(54),
  showPublicBrandText: integer("show_public_brand_text", { mode: "boolean" }).notNull().default(true),
  showAdminBrandText: integer("show_admin_brand_text", { mode: "boolean" }).notNull().default(true),
  primaryColor: text("primary_color").notNull().default("#174D3B"),
  adminSidebarColor: text("admin_sidebar_color").notNull().default("#133F31"),
