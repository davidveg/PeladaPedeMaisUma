...
export function calculateMobileTeamMetrics(team: Player[], result: TeamResult): TeamMetrics {
  ...
  let speed = 0, skill = 0, marking = 0, tacticalIntelligence=0, competitiveness=0, momentum = 0, total = 0;
  ...
  return { count, positions, speed, skill, marking, tacticalIntelligence, competitiveness, momentum, total, speedAvg: average(speed), skillAvg: average(skill), markingAvg: average(marking), tacticalIntelligenceAvg:average(tacticalIntelligence), competitivenessAvg:average(competitiveness), momentumAvg: average(momentum), scoreAvg: average(total) };
}
