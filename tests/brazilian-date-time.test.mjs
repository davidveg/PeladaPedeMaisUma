...
import { brazilianDateInput, brazilianDateOnly, brazilianDateTimeIso, brazilianDateTimeParts, brazilianTimeInput } from "../lib/brazilian-date-time.ts";
...
test("apresenta datas ISO sem horário no padrão brasileiro", () => {
  assert.equal(brazilianDateOnly("2026-05-07"), "07/05/2026");
  assert.equal(brazilianDateOnly("2026-02-31"), "");
  assert.equal(brazilianDateOnly(""), "");
});
